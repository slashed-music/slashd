...
<a href="https://open.spotify.com/" target="_blank" className="rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/10 transition">
<h3 className="font-semibold">Spotify</h3>
<p className="text-sm text-white/70 mt-1">Listen to releases and playlists.</p>
</a>
<a href="https://soundcloud.com/" target="_blank" className="rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/10 transition">
<h3 className="font-semibold">SoundCloud</h3>
<p className="text-sm text-white/70 mt-1">Demos, drafts, and WIPs.</p>
</a>
<a href="https://youtube.com/" target="_blank" className="rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/10 transition">
